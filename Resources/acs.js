var Cloud = require("ti.cloud"), acs = {
    pushNotify: function(e) {
        ...
        Cloud.PushNotifications.notify({
            ...
            e.success ? alert("Notify: Success") : e.callback({
                error: e.error,
                message: e.message
            });
        });
    ...
    pushSubscribe: function(e) {
        Cloud.PushNotifications.subscribe({
            ...
            e.success ? alert("Subscribe: Success") : e.callback({
                error: e.error,
                message: e.message
            });
        });
    ...
    emailSend: function(e) {
        Cloud.Emails.send({
            ...
            x.success ? alert("Driving Report Sent") : e.callback({
                error: x.error,
                message: x.message
            });
        });
